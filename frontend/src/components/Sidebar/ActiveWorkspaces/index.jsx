          ...
          >
            ...
            >
              ...
              transition-all duration-[200ms]
                flex flex-grow w-[75%] gap-x-2 py-[6px] px-[12px] rounded-[4px] text-typography-700 justify-start items-center
                ...
                <div className="flex flex-row justify-between w-full">
                  <div className="flex items-center space-x-2">
                    ...
                    <p
                      className={`text-[14px] leading-loose whitespace-nowrap overflow-hidden ${
                        isActive ? "text-typography-700 " : "text-zinc-800"
                      }`}
                    >
                      {isActive || isHovered
                  ...
                  user?.role !== "default" ? (
                    <div className="flex items-center gap-x-[2px]">
                      <div
                        className={`flex hover:bg-accent-700 p-[2px] rounded-[4px] text-[#A7A8A9] hover:text-[#fff] ${
                          uploadHover[workspace.id] ? "bg-accent-700" : ""
                        }`}
                      >
                        <button
                          type="button"
                      ...
                      <Link
                        ...
                        className="rounded-md flex items-center justify-center text-[#A7A8A9] hover:text-typography-700 ml-auto"
                      >
                        <div className="flex hover:bg-accent-700 p-[2px] rounded-[4px]">
                          <GearSix
                            weight="bold"
                            className={
                              isInWorkspaceSettings && workspace.slug === slug
                                ? "h-[20px] w-[20px] text-accent-300"
                                : gearHover[workspace.id]
                                ? "h-[20px] w-[20px] text-[#FFFFFF]"
                                : "h-[20px] w-[20px] text-[#A7A8A9]"
                            }
                          />
                        </div>
                      </Link>
