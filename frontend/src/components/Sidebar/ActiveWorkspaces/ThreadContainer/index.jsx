  ...
  return (
    ...
    >
      <div className="flex w-full gap-x-2 items-center pl-4">
        <div className="bg-zinc-600 hover:bg-accent-700 p-2 rounded-lg h-[24px] w-[24px] flex items-center justify-center">
          {loading ? (
            <CircleNotch
              weight="bold"
              size={14}
        ...
        {loading ? (
          ...
          <p className="text-left text-slate-800 text-sm">New Thread</p>
        )}
      </div>
    </button>
  );
