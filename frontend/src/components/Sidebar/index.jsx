              ...
              <div className="flex gap-x-2 items-center justify-between">
                {(!user || user?.role !== "default") && (
                  <button
                    ...
                    className="flex flex-grow w-[75%] h-[44px] gap-x-2 py-[5px] px-2.5 mb-2 bg-accent-700 rounded-[8px] text-sidebar justify-center items-center hover:bg-accent-900 transition-all duration-300"
                  >
