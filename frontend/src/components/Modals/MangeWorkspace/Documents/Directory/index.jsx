    ...
    <div className="px-8 pb-8">
      <div className="flex flex-col gap-y-6">
        <div className="flex items-center justify-between w-[560px] px-5 relative">
          <h3 className="text-typography-700 text-base font-bold">My Documents</h3>
          {showNewFolderInput ? (
            <div className="flex items-center gap-x-2 z-50">
              <input
                ...
                className="bg-input text-input-text border border-highlight placeholder-input-text/20 text-sm rounded-md p-2.5 w-[150px] h-[32px]"
              />
              <div className="flex gap-x-2">
                <button
                  onClick={confirmNewFolder}
                  className="text-accent-300 rounded-md text-sm font-bold hover:text-accent-500"
                >
                  Create
                </button>
              </div>
            ...
            <button
              className="flex items-center gap-x-2 cursor-pointer px-[14px] py-[7px] -mr-[14px] rounded-lg bg-accent-700 hover:bg-accent-900"
          ...
          <div className="overflow-y-auto h-full pt-8">
            {loading ? (
              <div className="w-full h-full flex items-center justify-center flex-col gap-y-5">
                <PreLoader />
                <p className="text-typography-700/80 text-sm font-semibold animate-pulse text-center w-1/3">
                  {loadingMessage}
                </p>
              </div>
            ) : files.items ? (
              ...
              <div className="mx-auto bg-white/40 rounded-lg py-1 px-2">
                <div className="flex flex-row items-center gap-x-2">
                  <button
                    ...
                    className="border-none text-sm font-semibold bg-white h-[30px] px-2.5 rounded-lg hover:text-typography-700 hover:bg-neutral-800/80"
                  >
                    Move to Workspace
                  </button>
