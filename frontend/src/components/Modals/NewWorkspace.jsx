      ...
      <div className="relative w-[500px] max-h-full">
        <div className="relative bg-modal-gradient rounded-lg shadow-md border-2 border-accent">
          <div className="flex items-start justify-between p-4 border-b rounded-t border-white/10">
            <h3 className="text-xl font-semibold text-typography-700">New Workspace</h3>
            <button
              onClick={hideModal}
              type="button"
          ...
          <form ref={formEl} onSubmit={handleCreate}>
            <div className="p-6 space-y-6 flex h-full w-full">
              <div className="w-full flex flex-col gap-y-4">
                <div>
                  <label
                    htmlFor="name"
                    className="block mb-2 text-sm font-medium text-typography-700"
                  >
                    Workspace Name
                  </label>
                  <input
                    ...
                    type="text"
                    id="name"
                    className="bg-zinc-50 w-full text-typography-700 placeholder:text-typography-700/20 text-sm rounded-lg border-slate-600 focus:border-slate-400 block w-full p-2.5"
            ...
            <div className="flex w-full justify-end items-center p-6 space-x-2 border-t border-white/10 rounded-b">
              <button
                type="submit"
                className="transition-all duration-300 border border-slate-200 px-4 py-2 rounded-lg text-[#fff] text-sm items-center flex gap-x-2 bg-accent-700 hover:bg-accent-900 hover:text-slate-800 focus:ring-gray-800"
              >
                Save
              </button>
            </div>
