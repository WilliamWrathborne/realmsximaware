      ...
      >
        ...
        >
          <div className="flex gap-x-5">
            ...
            <span
              className={`whitespace-pre-line text-typography-700 font-normal text-sm md:text-sm flex flex-col gap-y-1 mt-2`}
            >
          ...
          <div className="flex gap-x-5">
            ...
            <div>
              ...
              <a
                href={paths.github()}
                target="_blank"
                className="mt-5 w-fit transition-all duration-300 border border-slate-200 px-4 py-2 rounded-lg text-typography-700 text-sm items-center flex gap-x-2 hover:bg-slate-200 hover:text-slate-800 focus:ring-gray-800"
              >
