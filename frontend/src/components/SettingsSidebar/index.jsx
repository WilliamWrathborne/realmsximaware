            ...
            <div className="w-full h-full flex flex-col overflow-x-hidden items-between">
              ...
              <div className="flex w-full items-center justify-between gap-x-4">
                ...
                <div className="flex gap-x-2 items-center text-slate-500 shrink-0">
                  <a
                    href={paths.home()}
                    className="transition-all duration-300 p-2 rounded-full text-typography-700 bg-sidebar-button hover:bg-menu-item-selected-gradient hover:border-slate-100 hover:border-opacity-50 border-transparent border"
                  >
    ...
    <div>
      ...
      >
        <div className="w-full h-full flex flex-col overflow-x-hidden items-between min-w-[235px]">
          <div className="text-typography-700 text-opacity-60 text-sm font-medium uppercase mt-[4px] mb-0 ml-2">
            Instance Settings
          </div>
    ...
    <>
      <div className="flex gap-x-2 items-center justify-between">
        <Link
          ...
          hover:bg-workspace-item-selected-gradient hover:text-typography-700 hover:font-medium
          ${
            isActive
              ? "bg-menu-item-selected-gradient font-medium border-outline text-typography-700"
              : "hover:bg-menu-item-selected-gradient text-zinc-300"
          }
        `}
        >
