  ...
  return (
    <div className="mb-8">
      <div className="flex flex-col gap-y-1">
        <h2 className="text-base leading-6 font-bold text-typography-700">
          Custom Messages
        </h2>
        <p className="text-xs leading-[18px] font-base text-typography-700/60">
      ...
      <div className="mt-3 flex flex-col gap-y-6 bg-[#1C1E21] rounded-lg pr-[31px] pl-[12px] pt-4 max-w-[700px]">
        ...
        <div className="flex gap-4 mt-12 justify-between pb-[15px]">
          <button
            className="self-end text-typography-700 hover:text-typography-700/60 transition"
