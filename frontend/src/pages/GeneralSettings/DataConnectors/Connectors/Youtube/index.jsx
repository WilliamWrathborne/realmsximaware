            ...
            <form className="w-full" onSubmit={handleSubmit}>
                ...
                <div className="w-full flex items-center gap-4">
                  <div className="flex flex-col w-60">
                    <div className="flex flex-col gap-y-1 mb-4">
                      <label className="text-typography-700 text-sm font-semibold block">
                        YouTube video URL
                      </label>
                    </div>
                    <input
              ...
              <div className="flex flex-col gap-y-2 w-fit">
                <button
                  type="submit"
                  disabled={loading}
                  className="mt-2 text-lg w-fit border bg-accent-700 border-slate-200 px-4 py-1 rounded-lg text-white items-center flex gap-x-2 hover:bg-accent-900 hover:text-white/75 disabled:bg-slate-200 disabled:text-slate-800"
                >
