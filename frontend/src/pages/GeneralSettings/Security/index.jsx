      ...
      <div className="flex flex-col w-full px-1 md:px-20 md:py-12 py-16">
        <div className="w-full flex flex-col gap-y-1 pb-6 border-white border-b-2 border-opacity-10">
          <div className="items-center flex gap-x-4">
            <p className="text-2xl font-semibold text-typography-700">Multi-User Mode</p>
            {hasChanges && (
              <button
                type="submit"
                disabled={saving}
                ...
                {useMultiUserMode && (
                  <div className="w-full flex flex-col gap-y-2 my-5">
                    <div className="w-80">
                      <label
                        htmlFor="username"
                        className="block mb-3 font-medium text-typography-700"
                      >
                      ...
                      <input
                        name="username"
                        type="text"
                        className="bg-zinc-900 text-typography-700 text-sm rounded-lg focus:border-blue-500 block w-full p-2.5 placeholder:text-typography-700/20 focus:ring-blue-500"
