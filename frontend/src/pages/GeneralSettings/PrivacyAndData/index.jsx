        ...
        <div className="flex flex-col w-full px-1 md:px-20 md:py-12 py-16">
          <div className="w-full flex flex-col gap-y-1 pb-6 border-white border-b-2 border-opacity-10">
            <div className="items-center flex gap-x-4">
              <p className="text-2xl font-semibold text-typography-700">
                Privacy & Data-Handling
              </p>
            </div>
            <p className="text-sm font-base text-typography-700 text-opacity-60">
    ...
    <div className="py-8 w-full flex items-start justify-center flex-col gap-y-6 border-b-2 border-white/10">
      <div className="flex flex-col gap-8">
        <div className="flex flex-col gap-y-2 border-b border-zinc-500/50 pb-4">
          <div className="text-typography-700 text-base font-bold">LLM Selection</div>
          <div className="flex items-center gap-2.5">
            ...
            />
            <p className="text-typography-700 text-sm font-bold">
              {LLM_SELECTION_PRIVACY[llmChoice].name}
            </p>
          </div>
          <ul className="flex flex-col list-disc ml-4">
            {LLM_SELECTION_PRIVACY[llmChoice].description.map((desc) => (
              <li className="text-typography-700/90 text-sm">{desc}</li>
            ))}
          </ul>
        </div>
        <div className="flex flex-col gap-y-2 border-b border-zinc-500/50 pb-4">
          <div className="text-typography-700 text-base font-bold">Embedding Engine</div>
          <div className="flex items-center gap-2.5">
            <img
        ...
        <div className="flex flex-col gap-y-2 pb-4">
          <div className="text-typography-700 text-base font-bold">Vector Database</div>
          <div className="flex items-center gap-2.5">
            <img
      ...
      <div className="relative rounded-lg">
        ...
        <div className="space-y-6 flex h-full w-full">
          <div className="w-full flex flex-col gap-y-4">
            <div className="">
              <label className="mb-2.5 block font-medium text-typography-700">
        ...
        <div className="flex flex-col items-left space-y-2">
          <p className="text-typography-700/80 text-xs rounded-lg w-96">
