  ...
  if (loading)
    return (
      <div className="flex flex-col">
        ...
        <p className="text-typography-700 text-opacity-60 text-xs font-medium py-1.5">
    ...
    <div className="w-screen mt-6">
      ...
      {suggestedMessages.length < 4 && (
        <button
          type="button"
          onClick={addMessage}
          className="flex gap-x-2 items-center justify-center mt-6 text-typography-700 text-sm hover:text-sky-400 transition-all duration-300"
        >
      ...
      {hasChanges && (
        <div className="flex justify-start py-6">
          <button
            type="button"
            className="transition-all duration-300 border border-slate-200 px-4 py-2 rounded-lg bg-accent-700 text-white text-sm items-center flex gap-x-2 hover:bg-slate-200 hover:text-slate-800 focus:ring-gray-800"
