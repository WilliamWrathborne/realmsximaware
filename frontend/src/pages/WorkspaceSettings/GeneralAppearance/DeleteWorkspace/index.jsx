...
export default function DeleteWorkspace({ workspace }) {
  ...
  return (
    <button
      ...
      type="button"
      className="w-60 mt-[40px] transition-all duration-300 border border-transparent rounded-lg whitespace-nowrap text-sm px-5 py-2.5 focus:z-10 text-white bg-red-600/25 text-red-200 hover:text-white hover:bg-red-600 disabled:bg-red-600 disabled:text-red-200 disabled:animate-pulse"
    >
