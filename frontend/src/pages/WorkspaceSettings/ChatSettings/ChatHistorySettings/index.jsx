  ...
  return (
    <div>
      <div className="flex flex-col gap-y-1 mb-4">
        ...
        <p className="text-typography-700 text-opacity-60 text-xs font-medium">
      ...
      <input
        ...
        className="bg-zinc-900 text-typography-700 placeholder:text-typography-700/20 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
        placeholder="20"
        required={true}
        autoComplete="off"
