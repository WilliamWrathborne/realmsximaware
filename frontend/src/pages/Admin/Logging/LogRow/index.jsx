  ...
  return (
    <>
      <tr
        ...
        className={`bg-transparent text-typography-700 text-opacity-80 text-sm font-medium ${
          ...
          <>
            {expanded ? (
              ...
              >
                ...
                <p className="text-xs text-typography-700/50 w-[20px]">hide</p>
              </td>
            ) : (
              <td
                className={`px-2 gap-x-1 flex items-center justify-center transform transition-transform duration-200 hover:scale-105`}
              >
                ...
                <p className="text-xs text-typography-700/50 w-[20px]">show</p>
              </td>
            )}
          </>
        )}
...
const EventMetadata = ({ metadata, expanded = false }) => {
  ...
  return (
    <tr className="bg-sidebar">
      <td
        colSpan="2"
        className="px-6 py-4 font-medium text-typography-700 rounded-l-2xl"
      >
        Event Metadata
      </td>
      <td colSpan="4" className="px-6 py-4 rounded-r-2xl">
        <div className="w-full rounded-lg bg-main-2 p-2 text-typography-700 shadow-sm border-white border bg-opacity-10">
...
const EventBadge = ({ event }) => {
  ...
  return (
    <td className="px-6 py-4 font-medium whitespace-nowrap text-typography-700 flex items-center">
      <span
